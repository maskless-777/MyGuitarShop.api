...
public partial class MyGuitarShopContext : DbContext
{
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        {
            entity.HasKey(e => e.AddressId).HasName("PK__Addresse__091C2A1BED5670A3");
        ...
        {
            entity.HasKey(e => e.AdminId).HasName("PK__Administ__719FE4E8F29C6AE3");
        ...
        {
            entity.HasKey(e => e.CategoryId).HasName("PK__Categori__19093A2B1270761F");

            entity.HasIndex(e => e.CategoryName, "UQ__Categori__8517B2E00B37664C").IsUnique();
        ...
        {
            entity.HasKey(e => e.CustomerId).HasName("PK__Customer__A4AE64B85C4DC3AE");

            entity.HasIndex(e => e.EmailAddress, "UQ__Customer__49A14740E257996E").IsUnique();
        ...
        {
            entity.HasKey(e => e.OrderId).HasName("PK__Orders__C3905BAF26B3EE91");
        ...
        {
            entity.HasKey(e => e.ItemId).HasName("PK__OrderIte__727E83EBBD9E079D");
        ...
        {
            entity.HasKey(e => e.ProductId).HasName("PK__Products__B40CC6EDD4A98C23");

            entity.ToTable(tb => tb.HasTrigger("Products_INSERT"));

            entity.HasIndex(e => e.ProductCode, "UQ__Products__2F4E024FE0496EC8").IsUnique();
